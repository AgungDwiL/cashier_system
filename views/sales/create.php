...
<div class="row g-4">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary card-outline mb-4">
            <!--begin::Header-->
            <div class="card-header"><div class="card-title">Tambah Penjualan</div></div>
            <!--end::Header-->
            <!--begin::Form-->
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="customer_name" placeholder="Nama Pelanggan..." name="customer_name" class="form-control" required>
                </div>
                <div class="mb-3">
                                ...
                                <select class="form-control product" name="products[0][product_id]" required>
                                    ...
                                    <?php foreach ($products as $p) : ?>
                                        <option value="<?= $p['id'] ?>" 
                                            ...
                                            data-stock="<?= $p['stock'] ?>"
                                        >
                                            <?= $p['stock'] == 0 ? $p['name'] . ' (stok habis)' : $p['name'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
